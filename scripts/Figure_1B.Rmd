...
To reproduce the data from Kloosterman et al., 2024, be sure to have R (v4.3.2), Seurat (v4.4.0) and SeuratObject (v4.1.4) installed. Later versions may alter the outcome of analyses compared to the ones shown in the publication.
...
## Adding annotation on the samples that were excluded: sample S6018 as it had a extra-ordinary large tumor volume of 150mm2+ and S6017 as it contained no tumor cells
