---
title: "Kloosterman and Erbani et al., Cell 2024: Supplementary Figure 1A-H"
...
## Figure S1A: Justification for cluster naming
...
# Figure S1B: Generating data for heatmap (created in Prism) using published macrophages subset signature enrichment scores
...
# Figure S1C-D: Generating data for figure using GO annotation analysis on top 30 genes of each macrophage cluster, data was used to create graph in Prism
...
# Supplementary Figure S1G: Generate top30 gene annotation list for LLMs vs non-LLMs, data was used to create graph in Prism
...
# Figure S1H-I: Violinplot and percentage of GPNMB-high macrophages per macrophage cluster
